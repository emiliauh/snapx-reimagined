...
static const struct wl_pointer_listener pointer_listener={.enter=p_enter,.leave=p_leave,.motion=p_motion,.button=p_button,.axis=p_axis,.frame=p_frame,.axis_source=p_source,.axis_stop=p_stop,.axis_discrete=p_discrete,.axis_value120=p_value120,.axis_relative_direction=p_direction,.warp=p_warp};
